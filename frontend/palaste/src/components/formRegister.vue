<style scoped>
/* Normalize.css ya se encarga de resetear estilos predeterminados */
...
.button3 {
  margin-bottom: 1em; /* Reducido el margen inferior */
  padding: 0.5em;
  border-radius: 5px;
  border: none;
  outline: none;
...
/* Contenedor principal para centrar el formulario verticalmente */
.contenedor {
  display: flex;
  justify-content: center;
  align-items: center;
...
<template>
  <div class="contenedor">
    <form class="form">
      ...
      <button class="button3" @click="$router.push('/iniciar-sesion')">Already have an account? Login</button>
