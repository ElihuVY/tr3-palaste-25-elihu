<template>
    <div class="relative m-10 flex w-900 max-w-xs flex-col overflow-hidden rounded-lg border border-gray-100 bg-white shadow-md">
      <!-- Imagen del producto con descuento -->
      <a class="relative mx-3 mt-3 flex h-60 overflow-hidden rounded-xl" href="#">
        <img class="object-cover" :src="product.image" :alt="product.name" />
        <span v-if="product.discount" class="absolute top-0 left-0 m-2 rounded-full bg-black px-2 text-center text-sm font-medium text-white">
